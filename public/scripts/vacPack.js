const locPhoto = ['https://static.pexels.com/photos/3438/beach-holiday-vacation-caribbean.jpg', 'https://p0.pikist.com/photos/917/817/bora-bora-island-caribbean-tahiti-polynesia-paradise-travel-sea-nature.jpg',
    ...
    data.forEach((packages, idx) => {
      ...
      const pack = `
        <div class="package">
          ...
          <p class="vacayText">$${parseInt(packages.PkgBasePrice).toFixed(2)}</p>
          <a href="customer-registration.html"><button type="button" class="btn btn-primary">Order</button></a>
        </div>
        `;
